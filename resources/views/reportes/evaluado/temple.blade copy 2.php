    ...
    <div class="container">
        <div class="container mt-5">
            <div class="card shadow-lg border-0 rounded-3">
                ...
                <div class="card-body">
                    <p><strong>Nombre:</strong> {{ $registrosArray['nombre_afiliado'] }}</p>
                    <p><strong>Cédula:</strong> {{ $registrosArray['cedula_numero'] }}</p>
                    <p><strong>Caso:</strong> {{ $registrosArray['caso'] }}</p>
                    <p><strong>Fecha:</strong> {{ $registrosArray['fecha'] }}</p>
                    <p><strong>Estado Civil:</strong> {{ $registrosArray['estado_civil'] }}</p>
                    <p><strong>Amparo:</strong> {{ $registrosArray['amparo'] }}</p>
                    {{-- <p><strong>Tipo de Convivencia:</strong> {{ $registrosArray['tipo_de_convivencias'] }}</p> --}}
                    <p><strong>Otro:</strong> {{ $registrosArray['otro'] ?? 'N/A' }}</p>
                </div>
                <div class="card-footer text-center">
                    <button class="btn btn-success">Descargar PDF</button>
                </div>
            </div>
        </div>
        <!-- Datos Personales -->
...
<!-- Datos Personales -->
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <pstyle=" border-bottom: 1px solid #ccc;"><strong>Documentos Aportados:</strong> [Indicar si los documentos son auténticos o no]</pstyle=>
