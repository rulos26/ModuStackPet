...
class VerifyEmailNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Verifica tu dirección de correo electrónico - ModuStackPet')
            ->greeting('¡Hola!')
            ...
            ->line('**ModuStackPet**')
            ->line('')
            ->line('Si tienes problemas para hacer clic en el botón "Verificar Dirección de Correo", copia y pega la siguiente URL en tu navegador web:')
