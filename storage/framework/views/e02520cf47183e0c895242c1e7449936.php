<?php $__env->startSection('template_title', 'Actualizar Porcentaje de Ahorro'); ?>
            ...
            <div class="card shadow-lg border-0 bg-dark text-white" style="border-radius: 12px;">
                <div class="card-header bg-secondary text-white text-center" style="border-radius: 12px 12px 0 0;">
                    <h5 class="mb-0 text-uppercase font-weight-bold" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
                        <?php echo e(__('Editar Porcentaje de Ahorro')); ?>

                    </h5>
                </div>
                <div class="card-body bg-dark text-white p-4" style="border-radius: 0 0 12px 12px;">
                    <form method="POST" action="<?php echo e(route('porcentajes-ahorros.update', $porcentajesAhorro->id)); ?>" role="form" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-end mt-3">
                            ...
                            <button type="submit" class="btn btn-success" style="border-radius: 8px;">
                                <i class="fas fa-save"></i> <?php echo e(__('Actualizar')); ?>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ModuStack\ModuStack\ModuStack\resources\views/porcentajes-ahorro/edit.blade.php ENDPATH**/ ?>